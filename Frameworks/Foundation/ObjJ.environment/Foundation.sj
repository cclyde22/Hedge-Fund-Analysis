@STATIC;1.0;p;11;CPScanner.jt;7842;@STATIC;1.0;i;16;CPCharacterSet.ji;14;CPDictionary.ji;10;CPString.jt;7768;
...
p;17;CPDecimalNumber.jt;21692;@STATIC;1.0;i;11;CPDecimal.ji;13;CPException.ji;10;CPNumber.ji;10;CPObject.ji;10;CPString.jt;21593;
objj_executeFile("CPDecimal.j",YES);
objj_executeFile("CPException.j",YES);
objj_executeFile("CPNumber.j",YES);
objj_executeFile("CPObject.j",YES);
...
if(_raiseOnOverflow){
objj_msgSend(CPException,"raise:reason:",CPDecimalNumberOverflowException,("A CPDecimalNumber overflow has occured. (Left operand= '"+objj_msgSend(_20,"descriptionWithLocale:",nil)+"' Right operand= '"+objj_msgSend(_21,"descriptionWithLocale:",nil)+"' Selector= '"+_1e+"')"));
}else{
...
objj_msgSend(CPException,"raise:reason:",CPDecimalNumberUnderflowException,("A CPDecimalNumber underflow has occured. (Left operand= '"+objj_msgSend(_20,"descriptionWithLocale:",nil)+"' Right operand= '"+objj_msgSend(_21,"descriptionWithLocale:",nil)+"' Selector= '"+_1e+"')"));
}else{
return objj_msgSend(CPDecimalNumber,"notANumber");
}
break;
...
objj_msgSend(CPException,"raise:reason:",CPDecimalNumberDivideByZeroException,("A CPDecimalNumber divide by zero has occured. (Left operand= '"+objj_msgSend(_20,"descriptionWithLocale:",nil)+"' Right operand= '"+objj_msgSend(_21,"descriptionWithLocale:",nil)+"' Selector= '"+_1e+"')"));
}else{
return objj_msgSend(CPDecimalNumber,"notANumber");
}
break;
default:
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,("An unknown CPDecimalNumber error has occured. (Left operand= '"+objj_msgSend(_20,"descriptionWithLocale:",nil)+"' Right operand= '"+objj_msgSend(_21,"descriptionWithLocale:",nil)+"' Selector= '"+_1e+"')"));
}
return nil;
}
})]);
...
p;18;CPKeyValueCoding.jt;10409;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.ji;7;CPSet.ji;21;CPKeyValueObserving.jt;10275;
objj_executeFile("CPArray.j",YES);
objj_executeFile("CPDictionary.j",YES);
objj_executeFile("CPException.j",YES);
objj_executeFile("CPNull.j",YES);
